...
function parse (res) {
    ...
    this.logger && this.logger.silly('parse called.'); /* jshint ignore: line */
    ...
    res.on("end", function() {
        try {
            ...
            if (timestamp <= that.control.previousTimestamp) {
                ...
                this.logger && this.logger.silly('updated timestamp.'); /* jshint ignore: line */
            }

            clearInterval(that.control.retryReadIntervalObj);
            this.logger && this.logger.silly('cleared retryReadIntervalObj.'); /* jshint ignore: line */
            ...
            if (that.control.restartReader) {
                this.logger && this.logger.silly('restarting the feed reader.'); /* jshint ignore: line */
                restart.call(that);
            }

        } catch (e) {
            this.logger && this.logger.error('restarting the feed reader.', { e : e} ); /* jshint ignore: line */
