...
FeedReader.prototype.updateConfig = function (newConfig) {
    ...
    eventCreator.emitFeedUpdateStatus({ debug: 'GTFS-Realtime FeedReader config update started.', timestamp: parseInt(process.hrtime().join(''))/1000 });
    ...
    try {
         ...
         */
            ...
            try {
                ...
                eventCreator.emitError({ error: err, timestamp: parseInt(process.hrtime().join(''))/1000 });
