...
function resetResusitatorTimeout () {
    ...
    this.logger && this.logger.silly('resetResuscitatorTimeout: called.', { _this: this }); /* jshint ignore: line */
...
FeedReader.prototype.updateConfig = function (newConfig) {
    ...
    this.logger && this.logger.silly('updateConfig: called. calling restart', { config: this.config, control: this.control }); /* jshint ignore: line */
    restart.call(this);
};
...
function readFeed () {
    ...
    this.logger && this.logger.silly('readFeed: set lastReadTimestamp.'); /* jshint ignore: line */
