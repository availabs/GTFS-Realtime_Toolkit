...
function GTFSRealtimeObject (GTFSrt_JSON, GTFS) {
        ...
        switch (determineEntityType(entity)) {
            ...
            case 'TripUpdate' :
                ...
                if (!tripUpdateFilterMap[trip_id]) {
                    ...
                    stopTimeZero_A = 
                        (stopTimeUpdate_A && 
                        ((stopTimeUpdate_A.arrival && stopTimeUpdate_A.arrival.time) || (stopTimeUpdate_A.departure && stopTimeUpdate_A.departure.time))) || 
                        null;
                    ...
                    if (stopTimeZero_B && !stopTimeZero_A) {
                        ...
                        tripUpdateFilterMap[trip_id] = (stopTimeZero_B > stopTimeZero_A) ? entity.trip_update : tripUpdateFilterMap[trip_id];
    ...
    _.forEach(Object.keys(tripUpdateFilterMap),function (trip_id) {
        indexers.indexTripUpdate(theIndices, tripUpdateFilterMap[trip_id], GTFS);
    });
