...
var theAPI = {
    ...
    //TODO: These need to be fixed. routesIndex simply maps to trips serving route.
    //getTripUpdatesForRoute : function (route_id) {
        //return _.get(this.routesIndex, 'TripUpdates', null);
    //},


    //getVehiclePositionUpdatesForRoute : function (route_id) {
    ...
    getRouteIDForTrip : function (trip_id) {
        return _.get(this.getTripDescriptorForTrip(trip_id), 'route_id', null);
    },
    ...
    getExpectedArrivalTimeAtStopForTrip : function (trip_id, stop_id) {
        return _.get(this.getStopTimeUpdateForStopForTrip(trip_id, stop_id), ['arrival', 'time', 'low'], null);    
    },
    ...
    getExpectedDepartureTimeAtStopForTrip : function (trip_id, stop_id) {
        return _.get(this.getStopTimeUpdateForStopForTrip(trip_id, stop_id), ['departure', 'time', 'low'], null);
   },
    ...
    getVehiclePositionCurrentStatusForTrip : function (trip_id) {
        ...
        return Number.isInteger(curStatusCode) ? statusStrings[curStatusCode] : null;
    },
